...
export CARLA_ROOT=simulation/carla_root
export LEADERBOARD_ROOT=simulation/leaderboard
export SCENARIO_RUNNER_ROOT=simulation/scenario_runner
export DATA_ROOT=simulation/dataset
export SAVE_DIR=RQ4/results_latency
...
export SCENARIOS_PARAMETER=${LEADERBOARD_ROOT}/leaderboard/scenarios/scenario_parameter_$5.yaml
export RESULT_ROOT=${SAVE_DIR}/${3:-debug}
export EVAL_SETTING=v2x_final/town05_short_collab/r${1:-0}
...
export TEAM_AGENT=simulation/leaderboard/team_code/pnp_agent_e2e_latency.py
# V2X agent with BEV input to indicate the drivable area.
export TEAM_CONFIG=simulation/leaderboard/team_code/agent_config/pnp_config_$4.yaml
# model config file!
