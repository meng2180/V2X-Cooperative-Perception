...
# bash RQ4/rq4_cl.sh ${Route_id} ${Carla_port} ${CP_model} ${Agent_config} ${Scenario_config}

###start
bash RQ4/rq4_cl.sh 0 40000 early_fusion early_5_10 1
bash RQ4/rq4_cl.sh 0 40000 late_fusion late_5_10 1
bash RQ4/rq4_cl.sh 0 40000 fcooper fcooper_5_10 1
bash RQ4/rq4_cl.sh 0 40000 v2xvit v2xvit_5_10 1
bash RQ4/rq4_cl.sh 0 40000 single single_5_10 1