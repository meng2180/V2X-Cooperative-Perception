...
def main():
    ...
    AP_all = {}
    file_path = os.path.join(opt.model_dir,"AP.txt")
    ...
    log_file.write('veh_ap30: {} veh_ap50: {} veh_ap70: {} '\
                    ...
                    'bicy_ap30: {} bicy_ap50: {} bicy_ap70: {} '.format(all_class_results[0]['ap30'],all_class_results[0]['ap50'],all_class_results[0]['ap70'], \
