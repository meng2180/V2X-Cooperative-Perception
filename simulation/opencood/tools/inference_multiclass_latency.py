...
def main():
    ...
    # add latency
    latency_list = [200, 400, 600]

    file_path = os.path.join(opt.model_dir,"AP_latency.txt")
    ...
    for use_laplace in use_laplace_options:
        ...
        for latency in latency_list:
            ...
            print(f"Latency Added: {latency}ms.")
            hypes.update({"time_delay": latency})
            ...
            noise_level = f"{latency}_ms_" + opt.fusion_method + suffix + opt.note
