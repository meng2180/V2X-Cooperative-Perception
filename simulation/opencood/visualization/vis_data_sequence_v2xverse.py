...
if __name__ == '__main__':
    ...
    # params = load_yaml('./opencood/hypes_yaml/v2xverse/where2comm_debug_config.yaml') 原
    params = load_yaml('./opencood/hypes_yaml/v2xverse/codriving_multiclass_config.yaml')
