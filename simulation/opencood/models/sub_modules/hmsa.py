...
class HGTCavAttention(nn.Module):
    def __init__(self, dim, heads, num_types=2,
        ...
        torch.nn.init.xavier_uniform_(self.relation_att) # 原 torch.nn.init.xavier_uniform(self.relation_att)
        torch.nn.init.xavier_uniform_(self.relation_msg) # 原 torch.nn.init.xavier_uniform(self.relation_msg)
