...
def vis_detection_result(traffic,det_range,is_pred=False,id_start=0,scene_dict='',frame_id=''):
    ...
    for i in range(batch_size):
        object_bbox, _ = turn_traffic_into_bbox_fast(traffic[i].reshape(192, 96, -1),det_range) # 生成边界框。
...
def draw_result(object_bbox,det_range,idx=0,is_pred=False,scene_dict='',frame_id=''):
    ...
    if is_pred:
        ...
        plt.savefig('/home/phm/acct-agrtkx/agrtkx/cxxu/results_cx/result_vis/'+scene_dict_new+'_'+str(frame_id)+"_pred_check.png")
    else:
        # plt.savefig('/dssg/home/acct-agrtkx/agrtkx/cxxu/results_cx/result_vis/'+scene_dict_new+'_'+str(frame_id)+"_gt_check.png")
        plt.savefig('/home/phm/acct-agrtkx/agrtkx/cxxu/results_cx/result_vis/'+scene_dict_new+'_'+str(frame_id)+"_gt_check.png")
    return
...
def generate_bbox_multiclass(map_input,det_range,id=0,name='0'):
    ...
    plt.savefig('/home/phm/acct-agrtkx/agrtkx/cxxu/results_cx/check_warp/'+str(id)+name+'.jpg',bbox_inches='tight', pad_inches = -0.1)
