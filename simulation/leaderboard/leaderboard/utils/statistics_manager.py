...
PENALTY_STOP = 0.80
PENALTY_OUTSIDE_ROUTE_LANES = 0.8
...
class RouteRecord():
    def __init__(self):
        ...
        self.scores = {
            'score_route': 0,       # 0-100
            'score_penalty': 0,     # 0-1
            'score_composed': 0     # score_route * score_penalty
        }
...
class StatisticsManager(object):
    ...
    def compute_route_statistics(self, config, duration_time_system=-1, duration_time_game=-1, failure="", step=0):
        """
                ...
                if node.list_traffic_events:
                    ...
                    for event in node.list_traffic_events:
                        if event.get_type() == TrafficEventType.COLLISION_STATIC: 
                            ...
                            score_penalty *= PENALTY_OUTSIDE_ROUTE_LANES
                            ...
                            # Agent got blocked at (x=28.409, y=79.571, z=0.034)
