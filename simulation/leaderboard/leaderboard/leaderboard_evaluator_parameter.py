...
class LeaderboardEvaluator(object):
    ...
    def _cleanup(self):
        ...
        if self.agent_instance is not None:
            self.agent_instance.infer.save_mis_error()
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            scenario = RouteScenario(world=self.world, config=config, debug_mode=args.debug, \
                    ego_vehicles_num=self.ego_vehicles_num, log_dir=log_dir,scenario_parameter=scenario_parameter, mis_error=self.agent_instance.infer.t) # mis_error=self.agent_instance.infer.Mis_error
        ...
        # Run the scenario
        try:
            self.manager.run_scenario() # self.manager = leaderboard.scenarios.scenario_manager
    ...
    def run(self, args: argparse.Namespace):
        ...
        """
        route_indexer = RouteIndexer(args.routes, args.scenarios, args.repetitions) # RouteIndexer = leaderboard.utils.route_indexer
        print(f"Evaluation route: {args.routes}")
